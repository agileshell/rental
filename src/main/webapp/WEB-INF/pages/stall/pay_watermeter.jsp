...
<head>
    ...
    <script src="resources/stall/pay_watermeter.js"></script>
    ...
    <div class="row">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">缴纳水费</h3>
            </div>
            <form role="form" autocomplete="off" action="stall/payWatermeter" method="POST">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="firstRecord" type="text" class="form-control" id="firstRecord" value="${lastWatermeter}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="price" type="text" class="form-control" id="price" value="${watermeter}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="totalPrice">实收水费<span class="required-flag">*</span></label>
                        <div class="input-group">
                            <div class="input-group-addon">
